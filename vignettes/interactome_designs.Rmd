...
colData(lfq_qf_turboid[['peptides_raw']]) <- colData(lfq_qf_turboid)
```
...
colData(lfq_qf_turboid[['peptides']]) <- colData(lfq_qf_turboid)
```
...
colData(lfq_qf_turboid[['protein']]) <- colData(lfq_qf_turboid)
