...
and summarising to sites, and pooling the peptides that cannot be
localised rather than discarding them. Worked through in [PTM site
...
- [`parse_ptm_candidates_mq()`](https://lmb-mass-spec-compbio.github.io/biomasslmb/reference/parse_ptm_candidates_mq.md)
  : Parse MaxQuant PTM localisation probabilities into candidate
  residues
- [`parse_ptm_candidates_pd()`](https://lmb-mass-spec-compbio.github.io/biomasslmb/reference/parse_ptm_candidates_pd.md)
  : Parse Proteome Discoverer ptmRS site probabilities into candidate
  residues
...
- [`psm_tmt_phospho_mq`](https://lmb-mass-spec-compbio.github.io/biomasslmb/reference/psm_tmt_phospho_mq.md)
