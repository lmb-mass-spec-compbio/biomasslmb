...
#' be run after \code{\link{get_enriched_go}} and \code{\link{estimate_overrep}}.
...
#'
#' @param obj `data.frame` containing `goseq` results as generated by
#' \code{\link{get_enriched_go}} then \code{\link{estimate_overrep}}.
