...
They are not the same size, and the asymmetry is the enrichment: peptides appear in the biotin samples and vanish from the controls, not the other way round. Discarding features with missing values would remove that finding and leave the experiment looking like a weak version of itself.
