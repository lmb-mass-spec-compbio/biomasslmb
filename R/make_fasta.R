# The functions contained herein are a direct copy of the functions from camprotR and were all written by Charlotte Dawson (https://github.com/csdaw)
...
#'                           package = "biomasslmb")
#' crap <- get_contaminant_fasta_accessions(crap_fasta)
#'
#' \dontrun{
